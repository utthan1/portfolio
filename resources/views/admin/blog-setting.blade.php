    ...
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h2 class="text-white pb-2 fw-bold">Blogs Setting</h2>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary ml-2 accept-btn" data-toggle="modal" data-target="#statusModal" >Add Blogs</button>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    <a href="{{route('blog-delete', $item->id)}}"><button type="button" class="btn btn-danger ml-2">Delete</button></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
...
<div class="modal fade" id="statusModal" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('blog-setting')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Enter Journey Title"/>
                        </div>
                        <div class="form-group ">
