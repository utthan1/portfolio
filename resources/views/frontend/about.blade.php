...
<section class="sp_sm bg_col_g" id="a_brief_history">

    <div class="sub-header2 wow fadeInUp bfhst_fx" data-wow-delay="0.2s"
        style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
        <h2 class="title_hd f_col_b center wow fadeInUp" data-wow-delay="0.2s"
            style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">Journey</h2>
            ...
            <div class="timeline">
                ...
                <div class="timeline-nav">
                    @foreach ($journey as $item)
                        <div class="timeline-nav__item history_birth" data-target="bar_history_birth">{{$item->year}}</div>
                    @endforeach
                </div>
                                            ...
                                            <div class="hide full_cont">
                                                <p dir="ltr"
                                                    ...
                                                    <font color="#000000" face="Calibri, sans-serif"><span
                                                            style="font-size: 16px; white-space: pre-wrap;">{{$item->journey_desc}}</span></font><br />
                                                </p>
